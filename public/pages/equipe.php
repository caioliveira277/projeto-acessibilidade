<main id="inicio">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <p>Você está em <a class="sr-only sr-only-focusable" href="?view=home">Home</a> > <a class="sr-only sr-only-focusable" href="?view=equipe">Equipe</a></p>
      </div>
    </div>
    <div class="row">
      <div class="col">
      ...
      <div class="col-md-6 d-flex justify-content-around p-4">
        <div class="card equipe_cards">
          ...
          <div class="card-body text-white bg-dark">
            ...
            <p class="card-text">R.A. 2650832013009</p>
            <div class="text-center">
              <a href="#" class="btn text-center botao">PAGINA CRIADA</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex justify-content-around p-4">
        <div class="card equipe_cards">
          ...
          <div class="card-body text-white bg-dark">
            ...
            <p class="card-text">R.A. 1234567890</p>
            <div class="text-center">
              <a href="#" class="btn text-center botao">PAGINA CRIADA</a>
            </div>
          </div>
      ...
      <div class="col-md d-flex justify-content-around">
        <div class="card equipe_cards">
          ...
          <div class="card-body text-white bg-dark">
            ...
            <p class="card-text">R.A. 2650832013001</p>
            <div class="text-center">
              <a href="#" class="btn text-center botao">PAGINA CRIADA</a>
            </div>
          </div>
      ...
      <div class="col-md-6 d-flex justify-content-around p-4">
        <div class="card equipe_cards">
          ...
          <div class="card-body text-white bg-dark">
            ...
            <p class="card-text">Programador front-end</p>
            <p class="card-text">R.A. 123456678765</p>
            <div class="text-center">
              <a href="#" class="btn text-center botao">PAGINA CRIADA</a>
            </div>
          </div>
      ...
      <div class="col-md-6 d-flex justify-content-around p-4">
        <div class="card equipe_cards">
          ...
          <div class="card-body text-white bg-dark">
            ...
            <p class="card-text">Programador front-end</p>
            <p class="card-text">R.A. 2650832013004</p>
            <div class="text-center">
              <a href="#" class="btn text-center botao">PAGINA CRIADA</a>
            </div>
          </div>
