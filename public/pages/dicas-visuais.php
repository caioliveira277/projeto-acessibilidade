    ...
    <section class="container-fluid">
        <section class="row info-page-location d-flex justify-content-center">
            <section class="col-10">
                <p class="change-font-size"><strong >Você está em:</strong> <a class="mx-2" href="">HOME</a> > <a class="mx-2" href="">Dicas acessibilidade deficiência visual</a></p>
            </section>
        </section>
        <header class="row d-flex justify-content-around">
            <div class="col-10 title-tips">
