...
<head>
	...
	<meta name="author"
		content="Acessibilidade.com - Caio Oliveira, Juarez Souza, Leonardo Bozzi, Guilherme Moreira, Alex Teixeira" />
	...
	<header>
		<div class="acessibility-menu container">
			<div class="row">
				...
				<div
					class="col-12 col-md-4 mb-3 mb-md-0 d-flex align-items-center justify-content-center px-5 font-switch">
											...
											<div class="dropdown">
												...
												<ul class="dropdown-menu pe-4" aria-labelledby="dropdownMenuLinkHeader">
													<li><a class="dropdown-item text-white"
															...
															Visual</a></li>
													<li><a class="dropdown-item text-white"
															href="<?=BASE_URL?>/?view=deficiencia-motoras">Deficiência
															Motora</a></li>
													<li><a class="dropdown-item text-white"
															href="<?=BASE_URL?>/?view=deficiencia-cognitivas">Deficiência
															Cognitiva</a></li>
												</ul>
											</div>
										</li>
